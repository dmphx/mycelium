...
_ENUM_KEYS: dict[str, list[str]] = {
    ...
    "PLAYBACK_PROFILE": ["balanced", "apple_tv", "web"],
}
_INT_KEYS = {
    "ZILEAN_PG_PORT",
    "MIN_SEEDERS",
    ...
    "WANTED_FRESH_WINDOW_DAYS",
    "WANTED_FRESH_BATCH",
    "IDENTITY_REPAIR_INTERVAL_HOURS",
    "IDENTITY_REPAIR_BATCH",
    "STREMIO_ADDON_TIMEOUT_SEC",
}
...
HOT_RELOAD = {
    ...
    "MDBLIST_AUTO_REQUEST_CAP",
    "STREMIO_ADDON_URLS", "STREMIO_ADDON_TIMEOUT_SEC",
    "PLAYBACK_PROFILE", "SAFE_NEXT_EPISODE_PREPARE",
}
...
SETTING_GROUPS = [
    ...
    },
    {
        ...
        "keys": ["CATBOX_MODE", "CATBOX_LAZY_ADD", "CATBOX_PRELOAD",
                 "SAFE_NEXT_EPISODE_PREPARE", "CATBOX_HOST",
                 "CATBOX_IDLE_MINUTES", "CATBOX_GC_INTERVAL_MINUTES"],
    },
    {
        "id": "quality",
        ...
        "keys": [
            ...
            "EXCLUDE_UNDERSIZED_RELEASES",
            "VERIFY_RELEASE_BEFORE_GRAB", "SERIES_IDENTITY_CHECK",
            "MAX_MOVIE_SIZE_GB", "SERIES_PACK_NAME_REGEX",
            "WEB_PLAYER_MAX_SIZE_GB",
            "PLAYBACK_PROFILE",
        ],
    },
    ...
    },
    {
        ...
        "keys": [
            ...
            "WANTED_FRESH_INTERVAL_MINUTES", "WANTED_FRESH_WINDOW_DAYS",
            "WANTED_FRESH_BATCH", "IDENTITY_REPAIR_INTERVAL_HOURS",
            "IDENTITY_REPAIR_BATCH",
            "AUTO_APPROVE_INTERVAL_HOURS",
        ],
    },
